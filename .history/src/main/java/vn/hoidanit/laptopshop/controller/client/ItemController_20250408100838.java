...
public class ItemController {
    ...
    public String getProductPage(Model model,
        ...
        productCriteriaDTO.getFactory().ifPresent(factory -> model.addAttribute("factory", factory));
        productCriteriaDTO.getTarget().ifPresent(target -> model.addAttribute("target", target));
        productCriteriaDTO.getPrice().ifPresent(price -> model.addAttribute("price", price));
        productCriteriaDTO.getSort().ifPresent(sort -> model.addAttribute("sort", sort));
