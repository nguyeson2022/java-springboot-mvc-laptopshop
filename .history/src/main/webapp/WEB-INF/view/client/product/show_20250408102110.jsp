                                                ...
                                                <div class="pagination-container">
                                                    <ul class="pagination">
                                                        ...
                                                        <c:if test="${currentPage > 1}">
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="/products?page=${currentPage - 1}${not empty queryString ? '&'.concat(queryString) : ''}">&laquo;</a>
                                                            </li>
                                                        </c:if>
                                                        ...
                                                        <c:if test="${currentPage > 3}">
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="/products?page=1${not empty queryString ? '&'.concat(queryString) : ''}">1</a>
                                                            </li>
                                                        ...
                                                        <!-- Nearby pages -->
                                                        <c:forEach begin="${Math.max(1, currentPage - 1)}"
                                                            end="${Math.min(totalPages, currentPage + 1)}" var="i">
                                                            <li class="page-item ${currentPage == i ? 'active' : ''}">
                                                                <a class="page-link"
                                                                    href="/products?page=${i}${not empty queryString ? '&'.concat(queryString) : ''}">${i}</a>
                                                            </li>
                                                        </c:forEach>
                                                        ...
                                                        <c:if test="${currentPage < totalPages - 2}">
                                                            ...
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="/products?page=${totalPages}${not empty queryString ? '&'.concat(queryString) : ''}">${totalPages}</a>
                                                            </li>
                                                        </c:if>
                                                        ...
                                                        <c:if test="${currentPage < totalPages}">
                                                            <li class="page-item">
                                                                <a class="page-link"
                                                                    href="/products?page=${currentPage + 1}${not empty queryString ? '&'.concat(queryString) : ''}">&raquo;</a>
                                                            </li>
                                                        </c:if>
                                                    </ul>
                                                </div>
