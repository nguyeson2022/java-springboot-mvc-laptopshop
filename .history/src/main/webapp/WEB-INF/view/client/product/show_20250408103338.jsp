                ...
                <head>
                    ...
                    <script>
                        ...
                        document.getElementById("btnClearFilter").addEventListener("click", function () {
                            // Clear checkboxes
                            document.querySelectorAll('#factoryFilter input[type="checkbox"]').forEach(checkbox => checkbox.checked = false);
                            document.querySelectorAll('#targetFilter input[type="checkbox"]').forEach(checkbox => checkbox.checked = false);
                            document.querySelectorAll('#priceFilter input[type="checkbox"]').forEach(checkbox => checkbox.checked = false);

                            // Reset sort radio to default
                            document.querySelector('#sort-3').checked = true;
