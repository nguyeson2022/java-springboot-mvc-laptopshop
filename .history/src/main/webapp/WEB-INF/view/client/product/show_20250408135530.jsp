                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            if ('webkitSpeechRecognition' in window) {
                                ...
                                voiceSearchBtn.addEventListener("click", function () {
                                    ...
                                    voiceSearchBtn.innerHTML = '<i class="fas fa-microphone listening-animation"></i>';
                                });
                                            ...
                                            <div class="col-12" id="factoryFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-7"
                                                        value="MSI">
                                                    <label class="form-check-label" for="factory-7">Msi</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-8"
                                                        value="HP">
                                                    <label class="form-check-label" for="factory-8">Hp</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-9"
                                                        value="GIGABYTE">
                                                    <label class="form-check-label" for="factory-9">Gigabyte</label>
                                                </div>
                                            </div>
