        ...
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <body class="login-page">
                ...
                <style>
                    ...
                    .login-page {
                        background: url('D:/JavaNC_N4/05-java-spring-laptopshop-final-project-master/src/main/webapp/resources/images/avatar/1711517014402-pexels-huseyn-kamaladdin-667838.jpg') no-repeat center center fixed;
