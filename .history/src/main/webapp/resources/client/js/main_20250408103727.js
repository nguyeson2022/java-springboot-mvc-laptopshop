(function ($) {
    ...
    $('#btnClearFilter').click(function (event) {
        ...
        $("#factoryFilter .form-check-input").prop('checked', false);
        $("#targetFilter .form-check-input").prop('checked', false);
        $("#priceFilter .form-check-input").prop('checked', false);

        // Reset sort radio button
        $('input[name="radio-sort"]').first().prop('checked', true);
